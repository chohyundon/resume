...
export const experience: {
...
}[] = [
  {
    ...
    bullets: [
      ...
      [
        ...
        t("하며, 기능 구현 이후에도 사용성을 검증하고 보완하는 과정을 경험했습니다."),
      ],
    ],
  },
  {
  ...
  },
  {
    ...
    bullets: [
      [
        ...
        b("부원들의 개발 진행 상황과 어려움을 확인해 필요한 내용을 설명하거나 자료를 공유"),
        t("했습니다."),
      ],
      [
        t("직접 협업하며 겪은 시행착오를 바탕으로 Git Flow와 GitHub Flow를 비교하고, "),
  ...
  },
  {
    ...
    bullets: [
      ...
      [
        t("팀 프로젝트를 통해 "),
        b("Git 기반 협업과 컴포넌트 설계, API 연동, 배포까지 웹서비스 개발의 전체 흐름"),
        t("을 경험했습니다."),
      ],
    ],
  },
...
export const projects: Project[] = [
  {
    ...
    achievementsLabel: "체감 성능 개선",
    achievementsIntro: [
      t("개발하면서 하이드레이션 깜빡임이나 삭제 반응 지연처럼 "),
      hl("작은 부분들이 실제로는 사용 경험을 크게 좌우한다"),
      t("는 걸 느껴, 이런 지점들을 하나씩 찾아 개선했습니다."),
    ],
    achievements: [
      [
        t(
  ...
  },
  {
    ...
    achievementsLabel: "응답 속도 개선",
    achievementsIntro: [
      hl("외부 API와 대량 데이터에 의존하는 화면일수록 응답 지연이 누적되기 쉽다"),
      t("고 판단해, 데이터를 가져오는 방식과 사용자 액션에 대한 반응 속도를 함께 점검했습니다."),
    ],
    achievements: [
      [
        t(
